...
int main()
{
    int result1 = is_convex_polygon(4, (double)0, (double)0, (double)2, (double)2, (double)4, (double)0, (double)2, (double)-2);
    printf("Is the polygon convex? %s\n", result1 ? "No" : "Yes");
    double result2 = evaluate_polynomial(2.0, 3, 2.0, -3.0, 1.0);
    printf("Result: %f\n", result2);
}
